/* =====================================================================
   Smart Online Service — shared colourful "Connect with us" icons.
...
(function () {
  const ICON = {
    ...
    instagram: '<svg viewBox="0 0 24 24"><defs><linearGradient id="sosIg" x1="0" y1="1" x2="1" y2="0"><stop offset="0" stop-color="#feda75"/><stop offset=".5" stop-color="#d62976"/><stop offset="1" stop-color="#962fbf"/></linearGradient></defs><rect width="24" height="24" rx="6" fill="url(#sosIg)"/><rect x="6.4" y="6.4" width="11.2" height="11.2" rx="3.4" fill="none" stroke="#fff" stroke-width="1.5"/><circle cx="12" cy="12" r="2.7" fill="none" stroke="#fff" stroke-width="1.5"/><circle cx="15.7" cy="8.3" r="1.05" fill="#fff"/></svg>',
